export const SUCCESS = {
  ...
  REGISTRATION_SUCCESSFUL: 'Registration successful, OTP send to mobile number',
...
export const ERROR = {
  ...
  USER_EXISTS_WITH_EMAIL_MOBILE:
    'User already exists with the provided Email and Mobile number',
  USER_EXISTS_WITH_EMAIL: 'User already exists with the provided Email',
  USER_EXISTS_WITH_MOBILE:
